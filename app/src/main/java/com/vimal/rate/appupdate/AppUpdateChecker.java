package com.vimal.rate.appupdate;
...
//                    builder.show();
                ...
                new BottomDialog.Builder(activityWeakReference.get())
                        .setTitle("App Update \uD83D\uDE0D")
                        .setContent("New Version(" + latestAppVersionFromPlayStore + ") is Available on Play Store Please Update App \uD83D\uDE0B")
